<template>
    <div v-if="recipe" class="w-full min-h-screen relative bg-cover bg-center shadow-xl" :style="{ backgroundImage: `url(${recipeImage})`}">
            ...
            <div v-if="active === 'Instructions'" class="w-full mt-6">
                ...
                <div class="mt-4 flex flex-col gap-5">
                    <div v-for="(instruction, index) in recipe.instructions" :key="index" class="flex gap-4">
                        <div class="w-8 h-8 rounded-full bg-[#042628] text-white flex items-center justify-center shrink-0">
                            {{ index + 1 }}
                        </div>
                        <div class="flex-1">
